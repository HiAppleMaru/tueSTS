				...
				<tbody>
					<c:forEach var="item" items="${list}">
						<tr>
							...
							<td>${item.address}</td>
							<td>${item.phone}</td>
							<td><a href="delete/${item.custid}" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a> <a href="update/${item.custid}" class="btn btn-warning btn-sm"><i class="bi bi-wrench-adjustable"></i></a></td>
						</tr>
					</c:forEach>
